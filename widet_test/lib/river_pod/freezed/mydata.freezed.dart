...
abstract class $MyDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({int value, int age, bool isEnabled});
}
...
class _$_MyData implements _MyData {
  const _$_MyData({this.value = 5, this.age = 1, this.isEnabled = false});
  ...
  @override
  String toString() {
    return 'MyData(value: $value, age: $age, isEnabled: $isEnabled)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, value, age, isEnabled);
...
abstract class _MyData implements MyData {
  const factory _MyData(
      {final int value, final int age, final bool isEnabled}) = _$_MyData;
